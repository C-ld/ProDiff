...
import numpy as np
from modules.nowcastNet.layers.utils import warp, make_grid
from modules.nowcastNet.layers.generation.generative_network import Generative_Encoder, Generative_Decoder
from modules.nowcastNet.layers.evolution.evolution_network import Evolution_Network
from modules.nowcastNet.layers.generation.noise_projector import Noise_Projector
...
class NowcastNet(nn.Module):
    def __init__(self, hyparams):
        ...
        _configs = argparse.Namespace()
        for key, value in hyparams.items():
            setattr(_configs, key, value)
        
        _configs.evo_ic = _configs.total_length - _configs.input_length # 20
        _configs.gen_oc = _configs.total_length - _configs.input_length # 20
        _configs.ic_feature = _configs.ngf * 10                         # 320
